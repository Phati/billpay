    ...
    stages{
        ...
        stage('Deploy'){
            steps{
                ...
                withKubeConfig(caCertificate: '', clusterName: 'test-cluster-jenkins', contextName: '', credentialsId: 'kubernetes-scret', namespace: '', restrictKubeConfigAccess: false, serverUrl: 'https://34.173.16.60') {
