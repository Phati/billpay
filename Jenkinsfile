    ...
    stages{
        ...
        stage('Deploy'){
            steps{
                ...
                withKubeConfig(caCertificate: '', clusterName: 'my-first-cluster-1', contextName: '', credentialsId: 'final-kubectl', namespace: '', restrictKubeConfigAccess: false, serverUrl: 'https://34.173.16.60') {
